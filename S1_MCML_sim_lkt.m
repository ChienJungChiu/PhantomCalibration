...
%% param
output_dir='20251021'; % the already exist output folder, which containing the mus to simuilate
g=0;
n=1.457;
use_multiple_GPU=0; % =1 if you want to use multi-GPU to simulate
GPU_available=[1 1 1 1 1]; % which GPU on the multi-GPU computer to use
...
to_sim_index=3:10; % the index to simulate; how many index you want to analyze

sim_setting_file='sim_setup_new_param15E8.json';  %it is outside your output file
...
mother_dir=pwd;
% unit:mm
% dect_diam = (3*39/(sqrt(100^2-39^2)))*2 + 0.2 = 2.7412
% source_diam = (5*13/(sqrt(100^2-13^2)))*2 + 4 = 5.3111
